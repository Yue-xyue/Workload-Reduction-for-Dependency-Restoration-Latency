...
data_bytes = {
    "express-app": {
        "Baseline": {"P50": 2590720.0,  "P95": 3579904.0},
        "SDL":      {"P50":   69632.0,  "P95":  200704.0},
        "NDS":      {"P50":  796672.0,  "P95": 1077248.0},
        "SVsafe":   {"P50":  131072.0,  "P95":  262144.0},
    },
    "next-grofers": {
        "Baseline": {"P50": 20787200.0, "P95": 25870336.0},
        "SDL":      {"P50":    55296.0, "P95":   204800.0},
        "NDS":      {"P50": 11225088.0, "P95": 13561856.0},
        "SVsafe":   {"P50":   131072.0, "P95":   262144.0},
    },
    "ghost": {
        "Baseline": {"P50": 421982208.0, "P95": 538599424.0},
        # no SDL in ghost
        "NDS":      {"P50": 162529280.0, "P95": 177926144.0},
        "SVsafe":   {"P50":     49152.0, "P95":     196608.0},
    }
}
...
# -----------------------------
# 3-level broken axis limits (MiB) tuned for conc=8 edge:
#   - bottom: show SDL/SVsafe (0.046~0.25 MiB) + small NDS (0.76~1.03 MiB)
#   - mid: show express baseline (~2.5~3.4 MiB) + next baseline (~20~25 MiB) + next NDS (~10~13 MiB)
#   - top: show ghost baseline (~402~514 MiB) and ghost NDS (~155~170 MiB)
# -----------------------------
y_bot_max = 1.2
y_mid_min = 2.0
y_mid_max = 30.0
...
ax_mid.set_ylabel("Device read bytes (MiB)  [conc=8, mem=edge]")
...
plt.tight_layout()
out = "cg_io_rbytes_conc8_edge_p50_p95_brokenaxis_3level_mib.png"
